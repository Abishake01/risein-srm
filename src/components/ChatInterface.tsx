...
const ChatInterface = () => {
  ...
  return (
    <div className="relative bg-black/20 backdrop-blur-sm rounded-2xl border border-cyan-400/20 h-96 overflow-hidden shadow-xl shadow-cyan-400/20">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          {messages.map((message) => (
            ...
            >
              ...
              <div className={`max-w-md p-3 rounded-lg backdrop-blur-sm border border-cyan-400/20 ${
                message.type === 'user'
          ...
          {isTyping && (
            <div className="flex items-start space-x-3">
              ...
              <div className="bg-black/30 p-3 rounded-lg border border-cyan-400/20 backdrop-blur-sm">
        ...
        <div className="p-4 border-t border-cyan-400/10">
          <div className="flex flex-wrap gap-2 mb-3">
            {quickQuestions.map((question, index) => (
              <button
                ...
                className="flex items-center space-x-1 px-3 py-1 bg-gradient-to-r from-cyan-500/20 to-blue-500/20 hover:from-cyan-400/30 hover:to-blue-400/30 text-gray-300 text-sm rounded-full transition-all duration-300 border border-cyan-400/20 hover:border-cyan-400/40 shadow-sm hover:shadow-cyan-400/20"
              >
          ...
          <div className="flex space-x-2">
            <input
              ...
              className="flex-1 bg-black/30 border border-cyan-400/20 rounded-lg px-4 py-2 text-gray-100 placeholder-gray-400 focus:outline-none focus:border-cyan-400 transition-all duration-300 backdrop-blur-sm"
            />
            <button
              onClick={handleSendMessage}
              disabled={!inputValue.trim() || isTyping}
              className="px-4 py-2 bg-gradient-to-r from-cyan-500 to-blue-500 hover:from-cyan-400 hover:to-blue-400 disabled:from-gray-600 disabled:to-gray-600 disabled:cursor-not-allowed text-white rounded-lg transition-all duration-300 shadow-lg shadow-cyan-500/30 hover:shadow-cyan-500/40 border border-cyan-400/30"
            >
